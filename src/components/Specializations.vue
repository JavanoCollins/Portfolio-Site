    ...
    <section id="specialize">
        ...
        <div class="specials container">
            <Specialize class="one"
                ...
                :tools="webTools"
            />
            <Specialize class="two"
                icon="fas fa-brush"
                title="Designer"
                description="I have an extensive background in graphic design. I specialize in mobile and web design, logos, flyers, and business cards."
                subtitles="I enjoy designing"
                :subtools="designSubTools"
                :tools="designTools"
            />
        </div>
    </section>
...
export default {
    ...
    data() {
        return {
            ...
            designTools: ["VS Code", "Git", "Github", "Postman", "PyCharm", "Terminal"],
            webSubTools: ["JavaScript","Vue", "React", "SASS","Node", "Python", "MySQL"],
...
#specialize {
    background: linear-gradient(to left, #d12d00, #ff6c43);
    text-align: center;
    font-family: "Dosis";
    margin: 0 auto;
}
